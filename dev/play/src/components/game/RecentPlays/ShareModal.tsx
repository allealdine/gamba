    ...
    <Modal onClose={() => onClose()}>
      <div className="mt-6 grid gap-2.5 pb-0 w-full">
        <div className="rounded-lg overflow-hidden">
          <div
            ref={ref}
            className="border-2 relative bg-linear-to-br from-blue-800 to-purple-800 rounded-lg overflow-hidden shadow-3xl transform transition duration-500"
          >
            {shutterActive && (
            ...
            <div className="absolute inset-0 bg-linear-to-tr from-transparent via-white to-transparent opacity-20 transform rotate-12 scale-150 blur-xl pointer-events-none"></div>
