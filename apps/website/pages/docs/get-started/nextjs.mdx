    ...
    <div className="flex flex-col justify-center items-center mx-auto max-w-6xl max-sm:max-w-sm pt-20">
      {loading ? (
        <div className="w-full relative grid gap-1">
          <div className="relative grow bg-gray-800 rounded-lg overflow-hidden transition-height duration-200 md:min-h-[600px] min-h-[600px] flex items-center justify-center">
...
export default function CustomRenderer() {
  ...
  return (
    <>
      <div className="w-full relative grid gap-1">
        <div className="relative grow bg-gray-800 rounded-lg overflow-hidden transition-height duration-200 md:min-h-[600px] min-h-[600px]">
