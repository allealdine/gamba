      ...
      <div className="flex items-center justify-center">
        ...
        >
          {onClose && (
            <button
              onClick={onClose}
              className="w-10 h-10 z-50 absolute top-2.5 right-2.5 bg-transparent rounded-full p-2 hover:bg-white hover:bg-opacity-10 transition-opacity duration-200 ease-linear focus:outline-hidden min-w-[44px] min-h-[44px]"
            >
              <Icon.Close2 />
            </button>
          )}
