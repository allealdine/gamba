      ...
      {modalVisible && (
        <Modal onClose={() => setModalVisible(false)}>
          ...
          <div className="min-w-64">
            <h2 className="text-lg md:text-2xl font-bold">Select Token</h2>
            <div className="min-w-full flex flex-col gap-2">
              {tokensArray.map((token, index) => (
                <button
                  key={index}
                  className="hover:outline-solid hover:outline-1 flex items-center gap-2.5 px-2.5 py-2 rounded-lg w-full text-left"
